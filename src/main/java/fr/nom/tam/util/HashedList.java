...
public class HashedList implements Collection {
    ...
    private class HashedListIterator implements Cursor {
         ...
         */
        public void add(final Object ref) {
            // LAURENT: use Integer instance cache:
            final Integer nKey = NumberUtils.valueOf(unkeyedIndex);
            unkeyedIndex += 1;
    ...
    public boolean add(final Object reference) {
        // LAURENT: use Integer instance cache:
        final Integer nKey = NumberUtils.valueOf(unkeyedIndex);
        unkeyedIndex += 1;
