...
public final class BufferedFile
    ...
    public int read(boolean[] b, int start, int length) throws IOException {
        ...
        int i = start;
        try {
            for (int size = start + length; i < size; i += 1) {
    ...
    public int read(int[] i, int start, int length) throws IOException {
        ...
        int ii = start;
        try {
            for (int size = start + length; ii < size; ii += 1) {
                i[ii] = convertToInt();
            }
            return length * 4;
        } catch (EOFException e) {
    ...
    public void write(boolean[] b, int start, int length) throws IOException {
        for (int i = start, size = start + length; i < size; i += 1) {
    ...
    public void write(int[] i, int start, int length) throws IOException {
        for (int ii = start, size = start + length; ii < size; ii += 1) {
            convertFromInt(i[ii]);
        }
    }
