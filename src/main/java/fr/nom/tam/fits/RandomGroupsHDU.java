 ...
 */
public final class RandomGroupsHDU extends BasicHDU {
    ...
    public static boolean isHeader(Header hdr) {
        ...
        final String xten = hdr.getTrimmedStringValue("XTENSION");
        // LAURENT : avoid NPE
        if (xten == null) {
            return false;
        }
        if (xten.equals("IMAGE")) {
            return hdr.getBooleanValue("GROUPS");
        }
    ...
    public static Data manufactureData(Header hdr) throws FitsException {
        ...
        for (int i = 0; i < gcount; i += 1) {
            ...
            = ((Object[]) ArrayFuncs.deepClone(sampleRow))[0];
            ((Object[][]) dataArray)[i][1]
            = ((Object[]) ArrayFuncs.deepClone(sampleRow))[1];
        }
