...
public abstract class TableHDU extends BasicHDU {
    ...
    public int findColumn(String colName) {
        for (int i = 0, len = getNCols(); i < len; i += 1) {
            String val = getColumnName(i);
    ...
    public String getColumnName(int index) {
        return getColumnMeta(index, "TTYPE");
    }

    public void setColumnName(int index, String name, String comment)
            throws FitsException {
        // Insert TTYPE keyword before TFORM
        setColumnMeta(index, "TTYPE", name, (comment != null) ? comment : "ntf::tablehdu:ttype|" + (index + 1), false);
    }
    ...
    public String getColumnFormat(int index)
        ...
        return getColumnMeta(index, "TFORM");
    }
     ...
     *  TFORM value or after the column metadata
     * @param col    The 0-based index of the column
    ...
    public void setColumnName(final int index, final String name, final String comment, final String unit)
            throws FitsException {
        setColumnName(index, name, comment);
    ...
    public final String getColumnUnit(final int index) {
        return getColumnMeta(index, "TUNIT");
    }
