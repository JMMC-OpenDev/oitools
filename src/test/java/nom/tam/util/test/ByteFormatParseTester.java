...
public class ByteFormatParseTester {
  ...
  public void testFloat() throws Exception {
    ...
    bp.setOffset(0);
    assertEquals("FloatBlank", 0.f, bp.getFloat(10));
    ...
    for (int i = 0; i < flt.length; i += 1) {
      ...
      if (Float.isNaN(flt[i])) {
        ...
        assertEquals("Float check:" + i, flt[i], chk);
      } else {
  ...
  public void testDouble() throws Exception {
    ...
    bp.setOffset(0);
    assertEquals("DoubBlank", 0., bp.getDouble(10));
    ...
    for (int i = 0; i < dbl.length; i += 1) {
      ...
      if (Double.isNaN(dbl[i])) {
        ...
        assertEquals("Double check:" + i, dbl[i], chk);
      } else {
